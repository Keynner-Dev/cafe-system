...
// ── Pantalla de éxito ──────────────────────────────────────────────────────
// ÍTEM 31: handleImprimir ya no arma el HTML del ticket 80mm aquí mismo --
// toda la plantilla de impresión (ahora tamaño Carta) vive en
// utils/imprimirRemisionCarta.js, compartida con VentaDetalle.jsx.
function PantallaExito({ venta, onClose, onNuevaRemision }) {
  const handleImprimir = () => {
    imprimirRemisionCarta(venta, { pieTexto: 'Generado el' })
  }
